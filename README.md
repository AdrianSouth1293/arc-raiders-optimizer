...
[![Platform: Windows](https://img.shields.io/badge/Platform-Windows%2010%2F11-blue)](https://github.com/adrianSouth1293/arc-raiders-optimizer)
...
[![GitHub Stars](https://img.shields.io/github/stars/jordan-thirkle/arc-optimizer?style=social)](https://github.com/adrianSouth1293/arc-raiders-optimizer)
...
- [x] Microsoft Store submission (MSIX packaging)
- [x] Multi-language support
- [x] Automatic update checking
- [x] Custom preset system
- [ ] Per-map optimization profiles

## Acknowledgments

- [FPS](https://youtube.com/@) — ARC Raiders optimization research
- [r/OptimizedGaming](https://reddit.com/r/) — Per-setting breakdowns
- [PCGamingWiki](https://.) — Config locations and engine tweaks
